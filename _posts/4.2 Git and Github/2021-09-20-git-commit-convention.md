---
title: "[GIT] 아름다운 commit 메시지를 위한 규약(convention)"
categories:
  - GIT
tags:
  - git
...
3. 제목 **첫 글자는 대문자**로 작성
4. 제목 끝에 **마침표 넣지 않기**
5. 제목은 **명령문으로 사용**하며 과거형을 사용하지 않는다
...
Chris Beams의 [How to Write a Git Commit Message](https://chris.beams.io/posts/git-commit)  
and  
[NHN Cloud 좋은 git 커밋 메시지를 작성하기 위한 7가지 약속](https://meetup.toast.com/posts/106)
